...
/* What is seen. */
const FLAG_TYPE wear_loc_phrases[] = {
...
const FLAG_TYPE wear_loc_types[] = {
...
const FLAG_TYPE position_types[] = {
    {"dead",     POS_DEAD,     FALSE},
