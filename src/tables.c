...
const SKILL_T skill_table[SKILL_MAX + 1] = {
    ...
    {"acid blast",      {{28,  1}, {53,  1}, {35,  2}, {32,  2}}, spell_acid_blast,      TCO,  PF, NULL,                 SLOT (70),  20,  12, "acid blast",     "!Acid Blast!", ""},
    {"armor",           {{ 7,  1}, { 2,  1}, {10,  2}, { 5,  2}}, spell_armor,           TCD,  PS, NULL,                 SLOT (1),   5,   12, "",               "You feel less armored.", ""},
    {"bless",           {{53,  1}, { 7,  1}, {53,  2}, { 8,  2}}, spell_bless,           TOCD, PS, NULL,                 SLOT (3),   5,   12, "",               "You feel less righteous.", "$p's holy aura fades."},
    {"blindness",       {{12,  1}, { 8,  1}, {17,  2}, {15,  2}}, spell_blindness,       TCO,  PF, &gsn_blindness,       SLOT (4),   5,   12, "",               "You can see again.", ""},
    {"burning hands",   {{ 7,  1}, {53,  1}, {10,  2}, { 9,  2}}, spell_burning_hands,   TCO,  PF, NULL,                 SLOT (5),   15,  12, "burning hands",  "!Burning Hands!", ""},
    {"call lightning",  {{26,  1}, {18,  1}, {31,  2}, {22,  2}}, spell_call_lightning,  TI,   PF, NULL,                 SLOT (6),   15,  12, "lightning bolt", "!Call Lightning!", ""},
    {"calm",            {{48,  1}, {16,  1}, {50,  2}, {20,  2}}, spell_calm,            TI,   PF, NULL,                 SLOT (509), 30,  12, "",               "You have lost your peace of mind.", ""},
    {"cancellation",    {{18,  1}, {26,  1}, {34,  2}, {34,  2}}, spell_cancellation,    TCD,  PF, NULL,                 SLOT (507), 20,  12, "",               "!cancellation!",""},
    {"cause critical",  {{53,  1}, {13,  1}, {53,  2}, {19,  2}}, spell_cause_critical,  TCO,  PF, NULL,                 SLOT (63),  20,  12, "harmful spell",  "!Cause Critical!", ""},
    {"cause light",     {{53,  1}, { 1,  1}, {53,  2}, { 3,  2}}, spell_cause_light,     TCO,  PF, NULL,                 SLOT (62),  15,  12, "harmful spell",  "!Cause Light!", ""},
    {"cause serious",   {{53,  1}, { 7,  1}, {53,  2}, {10,  2}}, spell_cause_serious,   TCO,  PF, NULL,                 SLOT (64),  17,  12, "harmful spell",  "!Cause Serious!", ""},
    {"chain lightning", {{33,  1}, {53,  1}, {39,  2}, {36,  2}}, spell_chain_lightning, TCO,  PF, NULL,                 SLOT (500), 25,  12, "lightning",      "!Chain Lightning!", ""},
    {"change sex",      {{53,  1}, {53,  1}, {53,  2}, {53,  2}}, spell_change_sex,      TCD,  PF, NULL,                 SLOT (82),  15,  12, "",               "Your body feels familiar again.", ""},
    {"charm person",    {{20,  1}, {53,  1}, {25,  2}, {53,  2}}, spell_charm_person,    TCO,  PS, &gsn_charm_person,    SLOT (7),   5,   12, "",               "You feel more self-confident.", ""},
    {"chill touch",     {{ 4,  1}, {53,  1}, { 6,  2}, { 6,  2}}, spell_chill_touch,     TCO,  PF, NULL,                 SLOT (8),   15,  12, "chilling touch", "You feel less cold.", ""},
    {"colour spray",    {{16,  1}, {53,  1}, {22,  2}, {20,  2}}, spell_colour_spray,    TCO,  PF, NULL,                 SLOT (10),  15,  12, "colour spray",   "!Colour Spray!", ""},
    {"continual light", {{ 6,  1}, { 4,  1}, { 6,  2}, { 9,  2}}, spell_continual_light, TI,   PS, NULL,                 SLOT (57),  7,   12, "",               "!Continual Light!", ""},
    {"control weather", {{15,  1}, {19,  1}, {28,  2}, {22,  2}}, spell_control_weather, TI,   PS, NULL,                 SLOT (11),  25,  12, "",               "!Control Weather!", ""},
    {"create food",     {{10,  1}, { 5,  1}, {11,  2}, {12,  2}}, spell_create_food,     TI,   PS, NULL,                 SLOT (12),  5,   12, "",               "!Create Food!", ""},
    {"create rose",     {{16,  1}, {11,  1}, {10,  2}, {24,  2}}, spell_create_rose,     TI,   PS, NULL,                 SLOT (511), 30,  12, "",               "!Create Rose!", ""},
    {"create spring",   {{14,  1}, {17,  1}, {23,  2}, {20,  2}}, spell_create_spring,   TI,   PS, NULL,                 SLOT (80),  20,  12, "",               "!Create Spring!", ""},
    {"create water",    {{ 8,  1}, { 3,  1}, {12,  2}, {11,  2}}, spell_create_water,    TOI,  PS, NULL,                 SLOT (13),  5,   12, "",               "!Create Water!", ""},
    {"cure blindness",  {{53,  1}, { 6,  1}, {53,  2}, { 8,  2}}, spell_cure_blindness,  TCD,  PF, NULL,                 SLOT (14),  5,   12, "",               "!Cure Blindness!", ""},
    {"cure critical",   {{53,  1}, {13,  1}, {53,  2}, {19,  2}}, spell_cure_critical,   TCD,  PF, NULL,                 SLOT (15),  20,  12, "",               "!Cure Critical!", ""},
    {"cure disease",    {{53,  1}, {13,  1}, {53,  2}, {14,  2}}, spell_cure_disease,    TCD,  PS, NULL,                 SLOT (501), 20,  12, "",               "!Cure Disease!", ""},
    {"cure light",      {{53,  1}, { 1,  1}, {53,  2}, { 3,  2}}, spell_cure_light,      TCD,  PF, NULL,                 SLOT (16),  10,  12, "",               "!Cure Light!", ""},
    {"cure poison",     {{53,  1}, {14,  1}, {53,  2}, {16,  2}}, spell_cure_poison,     TCD,  PS, NULL,                 SLOT (43),  5,   12, "",               "!Cure Poison!", ""},
    {"cure serious",    {{53,  1}, { 7,  1}, {53,  2}, {10,  2}}, spell_cure_serious,    TCD,  PF, NULL,                 SLOT (61),  15,  12, "",               "!Cure Serious!", ""},
    {"curse",           {{18,  1}, {18,  1}, {26,  2}, {22,  2}}, spell_curse,           TOCO, PF, &gsn_curse,           SLOT (17),  20,  12, "curse",          "The curse wears off.", "$p is no longer impure."},
    {"demonfire",       {{53,  1}, {34,  1}, {53,  2}, {45,  2}}, spell_demonfire,       TCO,  PF, NULL,                 SLOT (505), 20,  12, "torments",       "!Demonfire!", ""},
    {"detect evil",     {{11,  1}, { 4,  1}, {12,  2}, {53,  2}}, spell_detect_evil,     TCS,  PS, NULL,                 SLOT (18),  5,   12, "",               "The red in your vision disappears.", ""},
    {"detect good",     {{11,  1}, { 4,  1}, {12,  2}, {53,  2}}, spell_detect_good,     TCS,  PS, NULL,                 SLOT (513), 5,   12, "",               "The gold in your vision disappears.", ""},
    {"detect hidden",   {{15,  1}, {11,  1}, {12,  2}, {53,  2}}, spell_detect_hidden,   TCS,  PS, NULL,                 SLOT (44),  5,   12, "",               "You feel less aware of your surroundings.", ""},
    {"detect invis",    {{ 3,  1}, { 8,  1}, { 6,  2}, {53,  2}}, spell_detect_invis,    TCS,  PS, NULL,                 SLOT (19),  5,   12, "",               "You no longer see invisible objects.", ""},
    {"detect magic",    {{ 2,  1}, { 6,  1}, { 5,  2}, {53,  2}}, spell_detect_magic,    TCS,  PS, NULL,                 SLOT (20),  5,   12, "",               "The detect magic wears off.", ""},
    {"detect poison",   {{15,  1}, { 7,  1}, { 9,  2}, {53,  2}}, spell_detect_poison,   TOI,  PS, NULL,                 SLOT (21),  5,   12, "",               "!Detect Poison!", ""},
    {"dispel evil",     {{53,  1}, {15,  1}, {53,  2}, {21,  2}}, spell_dispel_evil,     TCO,  PF, NULL,                 SLOT (22),  15,  12, "dispel evil",    "!Dispel Evil!", ""},
    {"dispel good",     {{53,  1}, {15,  1}, {53,  2}, {21,  2}}, spell_dispel_good,     TCO,  PF, NULL,                 SLOT (512), 15,  12, "dispel good",    "!Dispel Good!", ""},
    {"dispel magic",    {{16,  1}, {24,  1}, {30,  2}, {30,  2}}, spell_dispel_magic,    TCO,  PF, NULL,                 SLOT (59),  15,  12, "",               "!Dispel Magic!", ""},
    {"earthquake",      {{53,  1}, {10,  1}, {53,  2}, {14,  2}}, spell_earthquake,      TI,   PF, NULL,                 SLOT (23),  15,  12, "earthquake",     "!Earthquake!", ""},
    {"enchant armor",   {{16,  2}, {53,  2}, {53,  4}, {53,  4}}, spell_enchant_armor,   TOI,  PS, NULL,                 SLOT (510), 100, 24, "",               "!Enchant Armor!", ""},
    {"enchant weapon",  {{17,  2}, {53,  2}, {53,  4}, {53,  4}}, spell_enchant_weapon,  TOI,  PS, NULL,                 SLOT (24),  100, 24, "",               "!Enchant Weapon!", ""},
    {"energy drain",    {{19,  1}, {22,  1}, {26,  2}, {23,  2}}, spell_energy_drain,    TCO,  PF, NULL,                 SLOT (25),  35,  12, "energy drain",   "!Energy Drain!", ""},
    {"faerie fire",     {{ 6,  1}, { 3,  1}, { 5,  2}, { 8,  2}}, spell_faerie_fire,     TCO,  PF, NULL,                 SLOT (72),  5,   12, "faerie fire",    "The pink aura around you fades away.", ""},
    {"faerie fog",      {{14,  1}, {21,  1}, {16,  2}, {24,  2}}, spell_faerie_fog,      TI,   PS, NULL,                 SLOT (73),  12,  12, "faerie fog",     "!Faerie Fog!", ""},
    {"farsight",        {{14,  1}, {16,  1}, {16,  2}, {53,  2}}, spell_farsight,        TI,   PS, NULL,                 SLOT (521), 36,  20, "farsight",       "!Farsight!", ""},
    {"fireball",        {{22,  1}, {53,  1}, {30,  2}, {26,  2}}, spell_fireball,        TCO,  PF, NULL,                 SLOT (26),  15,  12, "fireball",       "!Fireball!", ""},
    {"fireproof",       {{13,  1}, {12,  1}, {19,  2}, {18,  2}}, spell_fireproof,       TOI,  PS, NULL,                 SLOT (523), 10,  12, "",               "", "$p's protective aura fades."},
    {"flamestrike",     {{53,  1}, {20,  1}, {53,  2}, {27,  2}}, spell_flamestrike,     TCO,  PF, NULL,                 SLOT (65),  20,  12, "flamestrike",    "!Flamestrike!", ""},
    {"fly",             {{10,  1}, {18,  1}, {20,  2}, {22,  2}}, spell_fly,             TCD,  PS, NULL,                 SLOT (56),  10,  18, "",               "You slowly float to the ground.", ""},
    {"floating disc",   {{ 4,  1}, {10,  1}, { 7,  2}, {16,  2}}, spell_floating_disc,   TI,   PS, NULL,                 SLOT (522), 40,  24, "",               "!Floating disc!", ""},
    {"frenzy",          {{53,  1}, {24,  1}, {53,  2}, {26,  2}}, spell_frenzy,          TCD,  PS, &gsn_frenzy,          SLOT (504), 30,  24, "",               "Your rage ebbs.", ""},
    {"gate",            {{27,  1}, {17,  1}, {32,  2}, {28,  2}}, spell_gate,            TI,   PF, NULL,                 SLOT (83),  80,  12, "",               "!Gate!", ""},
    {"giant strength",  {{11,  1}, {53,  1}, {22,  2}, {20,  2}}, spell_giant_strength,  TCD,  PS, NULL,                 SLOT (39),  20,  12, "",               "You feel weaker.", ""},
    {"harm",            {{53,  1}, {23,  1}, {53,  2}, {28,  2}}, spell_harm,            TCO,  PF, NULL,                 SLOT (27),  35,  12, "harmful spell",  "!Harm!,        " ""},
    {"haste",           {{21,  1}, {53,  1}, {26,  2}, {29,  2}}, spell_haste,           TCD,  PF, NULL,                 SLOT (502), 30,  12, "",               "You feel yourself slow down.", ""},
    {"heal",            {{53,  1}, {21,  1}, {33,  2}, {30,  2}}, spell_heal,            TCD,  PF, NULL,                 SLOT (28),  50,  12, "",               "!Heal!", ""},
    {"heat metal",      {{53,  1}, {16,  1}, {53,  2}, {23,  2}}, spell_heat_metal,      TCO,  PF, NULL,                 SLOT (516), 25,  18, "burn",           "!Heat Metal!", ""},
    {"holy word",       {{53,  2}, {36,  2}, {53,  4}, {42,  4}}, spell_holy_word,       TI,   PF, NULL,                 SLOT (506), 200, 24, "divine wrath",   "!Holy Word!", ""},
    {"identify",        {{15,  1}, {16,  1}, {18,  2}, {53,  2}}, spell_identify,        TOI,  PS, NULL,                 SLOT (53),  12,  24, "",               "!Identify!", ""},
    {"infravision",     {{ 9,  1}, {13,  1}, {10,  2}, {16,  2}}, spell_infravision,     TCD,  PS, NULL,                 SLOT (77),  5,   18, "",               "You no longer see in the dark.", ""},
    {"invisibility",    {{ 5,  1}, {53,  1}, { 9,  2}, {53,  2}}, spell_invis,           TOCD, PS, &gsn_invis,           SLOT (29),  5,   12, "",               "You are no longer invisible.", "$p fades into view."},
    {"know alignment",  {{12,  1}, { 9,  1}, {20,  2}, {53,  2}}, spell_know_alignment,  TCD,  PF, NULL,                 SLOT (58),  9,   12, "",               "!Know Alignment!", ""},
    {"lightning bolt",  {{13,  1}, {23,  1}, {18,  2}, {16,  2}}, spell_lightning_bolt,  TCO,  PF, NULL,                 SLOT (30),  15,  12, "lightning bolt", "!Lightning Bolt!", ""},
    {"locate object",   {{ 9,  1}, {15,  1}, {11,  2}, {53,  2}}, spell_locate_object,   TI,   PS, NULL,                 SLOT (31),  20,  18, "",               "!Locate Object!", ""},
    {"magic missile",   {{ 1,  1}, {53,  1}, { 2,  2}, { 2,  2}}, spell_magic_missile,   TCO,  PF, NULL,                 SLOT (32),  15,  12, "magic missile",  "!Magic Missile!", ""},
    {"mass healing",    {{53,  2}, {38,  2}, {53,  4}, {46,  4}}, spell_mass_healing,    TI,   PS, NULL,                 SLOT (508), 100, 36, "",               "!Mass Healing!", ""},
    {"mass invis",      {{22,  1}, {25,  1}, {31,  2}, {53,  2}}, spell_mass_invis,      TI,   PS, &gsn_mass_invis,      SLOT (69),  20,  24, "",               "You are no longer invisible.", ""},
    {"nexus",           {{40,  2}, {35,  2}, {50,  4}, {45,  4}}, spell_nexus,           TI,   PS, NULL,                 SLOT (520), 150, 36, "",               "!Nexus!", ""},
    {"pass door",       {{24,  1}, {32,  1}, {25,  2}, {37,  2}}, spell_pass_door,       TCS,  PS, NULL,                 SLOT (74),  20,  12, "",               "You feel solid again.", ""},
    {"plague",          {{23,  1}, {17,  1}, {36,  2}, {26,  2}}, spell_plague,          TCO,  PF, &gsn_plague,          SLOT (503), 20,  12, "sickness",       "Your sores vanish.", ""},
    {"poison",          {{17,  1}, {12,  1}, {15,  2}, {21,  2}}, spell_poison,          TOCO, PF, &gsn_poison,          SLOT (33),  10,  12, "poison",         "You feel less sick.", "The poison on $p dries up."},
    {"portal",          {{35,  2}, {30,  2}, {45,  4}, {40,  4}}, spell_portal,          TI,   PS, NULL,                 SLOT (519), 100, 24, "",               "!Portal!", ""},
    {"protection evil", {{12,  1}, { 9,  1}, {17,  2}, {11,  2}}, spell_protection_evil, TCS,  PS, NULL,                 SLOT (34),  5,   12, "",               "You feel less protected.", ""},
    {"protection good", {{12,  1}, { 9,  1}, {17,  2}, {11,  2}}, spell_protection_good, TCS,  PS, NULL,                 SLOT (514), 5,   12, "",               "You feel less protected.", ""},
    {"ray of truth",    {{53,  1}, {35,  1}, {53,  2}, {47,  2}}, spell_ray_of_truth,    TCO,  PF, NULL,                 SLOT (518), 20,  12, "ray of truth",   "!Ray of Truth!", ""},
    {"recharge",        {{ 9,  1}, {53,  1}, {53,  2}, {53,  2}}, spell_recharge,        TOI,  PS, NULL,                 SLOT (517), 60,  24, "",               "!Recharge!", ""},
    {"refresh",         {{ 8,  1}, { 5,  1}, {12,  2}, { 9,  2}}, spell_refresh,         TCD,  PS, NULL,                 SLOT (81),  12,  18, "refresh",        "!Refresh!", ""},
    {"remove curse",    {{53,  1}, {18,  1}, {53,  2}, {22,  2}}, spell_remove_curse,    TOCD, PS, NULL,                 SLOT (35),  5,   12, "",               "!Remove Curse!", ""},
    {"sanctuary",       {{36,  1}, {20,  1}, {42,  2}, {30,  2}}, spell_sanctuary,       TCD,  PS, &gsn_sanctuary,       SLOT (36),  75,  12, "",               "The white aura around your body fades.", ""},
    {"shield",          {{20,  1}, {35,  1}, {35,  2}, {40,  2}}, spell_shield,          TCD,  PS, NULL,                 SLOT (67),  12,  18, "",               "Your force shield shimmers then fades away.", ""},
    {"shocking grasp",  {{10,  1}, {53,  1}, {14,  2}, {13,  2}}, spell_shocking_grasp,  TCO,  PF, NULL,                 SLOT (53),  15,  12, "shocking grasp", "!Shocking Grasp!", ""},
    {"sleep",           {{10,  1}, {53,  1}, {11,  2}, {53,  2}}, spell_sleep,           TCO,  PS, &gsn_sleep,           SLOT (38),  15,  12, "",               "You feel less tired.", ""},
    {"slow",            {{23,  1}, {30,  1}, {29,  2}, {32,  2}}, spell_slow,            TCO,  PF, NULL,                 SLOT (515), 30,  12, "",               "You feel yourself speed up.", ""},
    {"stone skin",      {{25,  1}, {40,  1}, {40,  2}, {45,  2}}, spell_stone_skin,      TCS,  PS, NULL,                 SLOT (66),  12,  18, "",               "Your skin feels soft again.", ""},
    {"summon",          {{24,  1}, {12,  1}, {29,  2}, {22,  2}}, spell_summon,          TI,   PS, NULL,                 SLOT (40),  50,  12, "",               "!Summon!", ""},
    {"teleport",        {{13,  1}, {22,  1}, {25,  2}, {36,  2}}, spell_teleport,        TCS,  PF, NULL,                 SLOT (2),   35,  12, "",               "!Teleport!", ""},
    {"ventriloquate",   {{ 1,  1}, {53,  1}, { 2,  2}, {53,  2}}, spell_ventriloquate,   TI,   PS, NULL,                 SLOT (41),  5,   12, "",               "!Ventriloquate!", ""},
    {"weaken",          {{11,  1}, {14,  1}, {16,  2}, {17,  2}}, spell_weaken,          TCO,  PF, NULL,                 SLOT (68),  20,  12, "spell",          "You feel stronger.", ""},
    {"word of recall",  {{32,  1}, {28,  1}, {40,  2}, {30,  2}}, spell_word_of_recall,  TCS,  PR, NULL,                 SLOT (42),  5,   12, "",               "!Word of Recall!", ""},

    /* Dragon breath */
    {"acid breath",     {{31,  1}, {32,  1}, {33,  2}, {34,  2}}, spell_acid_breath,     TCO,  PF, NULL,                 SLOT (200), 100, 24, "blast of acid",  "!Acid Breath!", ""},
    {"fire breath",     {{40,  1}, {45,  1}, {50,  2}, {51,  2}}, spell_fire_breath,     TCO,  PF, NULL,                 SLOT (201), 200, 24, "blast of flame", "The smoke leaves your eyes.", ""},
    {"frost breath",    {{34,  1}, {36,  1}, {38,  2}, {40,  2}}, spell_frost_breath,    TCO,  PF, NULL,                 SLOT (202), 125, 24, "blast of frost", "!Frost Breath!", ""},
    {"gas breath",      {{39,  1}, {43,  1}, {47,  2}, {50,  2}}, spell_gas_breath,      TI,   PF, NULL,                 SLOT (203), 175, 24, "blast of gas",   "!Gas Breath!", ""},
    {"lightning breath",{{37,  1}, {40,  1}, {43,  2}, {46,  2}}, spell_lightning_breath,TCO,  PF, NULL,                 SLOT (204), 150, 24, "blast of lightning", "!Lightning Breath!", ""},

    /* Spells for mega1.are from Glop/Erkenbrand. */
    {"general purpose", {{53,  0}, {53,  0}, {53,  0}, {53,  0}}, spell_general_purpose, TCO,  PF, NULL,                 SLOT (401), 0,   12, "general purpose ammo","!General Purpose Ammo!", ""},
    {"high explosive",  {{53,  0}, {53,  0}, {53,  0}, {53,  0}}, spell_high_explosive,  TCO,  PF, NULL,                 SLOT (402), 0,   12, "high explosive ammo", "!High Explosive Ammo!", ""},

    /* combat and weapons skills */
    {"axe",             {{ 1,  6}, { 1,  6}, { 1,  5}, { 1,  4}}, spell_null,            TI,   PF, &gsn_axe,             SLOT (0),   0,   0,  "",               "!Axe!", ""},
    {"dagger",          {{ 1,  2}, { 1,  3}, { 1,  2}, { 1,  2}}, spell_null,            TI,   PF, &gsn_dagger,          SLOT (0),   0,   0,  "",               "!Dagger!", ""},
    {"flail",           {{ 1,  6}, { 1,  3}, { 1,  6}, { 1,  4}}, spell_null,            TI,   PF, &gsn_flail,           SLOT (0),   0,   0,  "",               "!Flail!", ""},
    {"mace",            {{ 1,  5}, { 1,  2}, { 1,  3}, { 1,  3}}, spell_null,            TI,   PF, &gsn_mace,            SLOT (0),   0,   0,  "",               "!Mace!", ""},
    {"polearm",         {{ 1,  6}, { 1,  6}, { 1,  6}, { 1,  4}}, spell_null,            TI,   PF, &gsn_polearm,         SLOT (0),   0,   0,  "",               "!Polearm!", ""},
    {"shield block",    {{ 1,  6}, { 1,  4}, { 1,  6}, { 1,  2}}, spell_null,            TI,   PF, &gsn_shield_block,    SLOT (0),   0,   0,  "",               "!Shield!", ""},
    {"spear",           {{ 1,  4}, { 1,  4}, { 1,  4}, { 1,  3}}, spell_null,            TI,   PF, &gsn_spear,           SLOT (0),   0,   0,  "",               "!Spear!", ""},
    {"sword",           {{ 1,  5}, { 1,  6}, { 1,  3}, { 1,  2}}, spell_null,            TI,   PF, &gsn_sword,           SLOT (0),   0,   0,  "",               "!Sword!", ""},
    {"whip",            {{ 1,  6}, { 1,  5}, { 1,  5}, { 1,  4}}, spell_null,            TI,   PF, &gsn_whip,            SLOT (0),   0,   0,  "",               "!Whip!", ""},
    {"backstab",        {{53,  0}, {53,  0}, { 1,  5}, {53,  0}}, spell_null,            TI,   PS, &gsn_backstab,        SLOT (0),   0,   24, "backstab",       "!Backstab!", ""},
    {"bash",            {{53,  0}, {53,  0}, {53,  0}, { 1,  4}}, spell_null,            TI,   PF, &gsn_bash,            SLOT (0),   0,   24, "bash",           "!Bash!", ""},
    {"berserk",         {{53,  0}, {53,  0}, {53,  0}, {18,  5}}, spell_null,            TI,   PF, &gsn_berserk,         SLOT (0),   0,   24, "",               "You feel your pulse slow down.", ""},
    {"dirt kicking",    {{53,  0}, {53,  0}, { 3,  4}, { 3,  4}}, spell_null,            TI,   PF, &gsn_dirt,            SLOT (0),   0,   24, "kicked dirt",    "You rub the dirt out of your eyes.", ""},
    {"disarm",          {{53,  0}, {53,  0}, {12,  6}, {11,  4}}, spell_null,            TI,   PF, &gsn_disarm,          SLOT (0),   0,   24, "",               "!Disarm!", ""},
    {"dodge",           {{20,  8}, {22,  8}, { 1,  4}, {13,  6}}, spell_null,            TI,   PF, &gsn_dodge,           SLOT (0),   0,   0,  "",               "!Dodge!", ""},
    {"enhanced damage", {{45, 10}, {30,  9}, {25,  5}, { 1,  3}}, spell_null,            TI,   PF, &gsn_enhanced_damage, SLOT (0),   0,   0,  "",               "!Enhanced Damage!", ""},
    {"envenom",         {{53,  0}, {53,  0}, {10,  4}, {53,  0}}, spell_null,            TI,   PR, &gsn_envenom,         SLOT (0),   0,   36, "",               "!Envenom!", ""},
    {"hand to hand",    {{25,  8}, {10,  5}, {15,  6}, { 6,  4}}, spell_null,            TI,   PF, &gsn_hand_to_hand,    SLOT (0),   0,   0,  "",               "!Hand to Hand!", ""},
    {"kick",            {{53,  0}, {12,  4}, {14,  6}, { 8,  3}}, spell_null,            TCO,  PF, &gsn_kick,            SLOT (0),   0,   12, "kick",           "!Kick!", ""},
    {"parry",           {{22,  8}, {20,  8}, {13,  6}, { 1,  4}}, spell_null,            TI,   PF, &gsn_parry,           SLOT (0),   0,   0,  "",               "!Parry!", ""},
    {"rescue",          {{53,  0}, {53,  0}, {53,  0}, { 1,  4}}, spell_null,            TI,   PF, &gsn_rescue,          SLOT (0),   0,   12, "",               "!Rescue!", ""},
    {"trip",            {{53,  0}, {53,  0}, { 1,  4}, {15,  8}}, spell_null,            TI,   PF, &gsn_trip,            SLOT (0),   0,   24, "trip",           "!Trip!", ""},
    {"second attack",   {{30, 10}, {24,  8}, {12,  5}, { 5,  3}}, spell_null,            TI,   PF, &gsn_second_attack,   SLOT (0),   0,   0,  "",               "!Second Attack!", ""},
    {"third attack",    {{53,  0}, {53,  0}, {24, 10}, {12,  4}}, spell_null,            TI,   PF, &gsn_third_attack,    SLOT (0),   0,   0,  "",               "!Third Attack!", ""},

    /* non-combat skills */
    {"fast healing",    {{15,  8}, { 9,  5}, {16,  6}, { 6,  4}}, spell_null,            TI,   PP, &gsn_fast_healing,    SLOT (0),   0,   0,  "",               "!Fast Healing!", ""},
    {"haggle",          {{ 7,  5}, {18,  8}, { 1,  3}, {14,  6}}, spell_null,            TI,   PR, &gsn_haggle,          SLOT (0),   0,   0,  "",               "!Haggle!", ""},
    {"hide",            {{53,  0}, {53,  0}, { 1,  4}, {12,  6}}, spell_null,            TI,   PR, &gsn_hide,            SLOT (0),   0,   12, "",               "!Hide!", ""},
    {"lore",            {{ 5,  6}, { 6,  8}, { 7, 10}, { 8, 12}}, spell_null,            TI,   PR, &gsn_lore,            SLOT (0),   0,   36, "",               "!Lore!", ""},
    {"meditation",      {{ 6,  5}, { 6,  5}, {15,  8}, {15,  8}}, spell_null,            TI,   PP, &gsn_meditation,      SLOT (0),   0,   0,  "",               "Meditation", ""},
    {"peek",            {{ 8,  5}, {21,  7}, { 1,  3}, {14,  6}}, spell_null,            TI,   PS, &gsn_peek,            SLOT (0),   0,   0,  "",               "!Peek!", ""},
    {"pick lock",       {{25,  8}, {25,  8}, { 7,  4}, {25,  8}}, spell_null,            TI,   PS, &gsn_pick_lock,       SLOT (0),   0,   12, "",               "!Pick!", ""},
    {"sneak",           {{53,  0}, {53,  0}, { 4,  4}, {10,  6}}, spell_null,            TI,   PS, &gsn_sneak,           SLOT (0),   0,   12, "",               "You no longer feel stealthy.", ""},
    {"steal",           {{53,  0}, {53,  0}, { 5,  4}, {53,  0}}, spell_null,            TI,   PS, &gsn_steal,           SLOT (0),   0,   24, "",               "!Steal!", ""},
    {"scrolls",         {{ 1,  2}, { 1,  3}, { 1,  5}, { 1,  8}}, spell_null,            TI,   PS, &gsn_scrolls,         SLOT (0),   0,   24, "",               "!Scrolls!", ""},
    {"staves",          {{ 1,  2}, { 1,  3}, { 1,  5}, { 1,  8}}, spell_null,            TI,   PS, &gsn_staves,          SLOT (0),   0,   12, "",               "!Staves!", ""},
    {"wands",           {{ 1,  2}, { 1,  3}, { 1,  5}, { 1,  8}}, spell_null,            TI,   PS, &gsn_wands,           SLOT (0),   0,   12, "",               "!Wands!", ""},
    {"recall",          {{ 1,  2}, { 1,  2}, { 1,  2}, { 1,  2}}, spell_null,            TI,   PS, &gsn_recall,          SLOT (0),   0,   12, "",               "!Recall!", ""},
